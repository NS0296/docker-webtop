...
cat <<EOL > /config/Desktop/firefox-abc.desktop
[Desktop Entry]
Version=1.0
...
# 设置快捷方式文件的权限
chmod +x /config/Desktop/firefox-abc.desktop

cat <<EOL > /config/Desktop/vlc-abc.desktop
[Desktop Entry]
Version=1.0
Name=vlc (Run as abc)
...
# 设置快捷方式文件的权限
chmod +x /config/Desktop/vlc-abc.desktop
